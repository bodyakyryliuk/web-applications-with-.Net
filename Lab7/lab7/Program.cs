...
//                Console.WriteLine($"{elem.Number} -> {elem.Word}");
        ...
        static void Main()
        {
            ...
            // task1.GroupStudents(3);
            // task2.SortTopicsByFrequency();
            // task2.SortTopicsByFrequencyWithinGender();
            // Task3.TransformToStudents(Generator.GenerateStudentsWithTopicsEasy()).ForEach(student => Console.WriteLine(student.ToString()));
            // Task3.TransformToStudentsWithGeneratedTopics(Generator.GenerateStudentsWithTopicsEasy()).ForEach(student => Console.WriteLine(student.ToString()));
            Task4.task4();
        }
    }
}
